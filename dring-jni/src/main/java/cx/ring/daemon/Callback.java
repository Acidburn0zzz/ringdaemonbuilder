...
public class Callback {
  ...
  public void voiceMailNotify(String call_id, int nd_msg) {
    if (getClass() == Callback.class) RingserviceJNI.Callback_voiceMailNotify(swigCPtr, this, call_id, nd_msg); else RingserviceJNI.Callback_voiceMailNotifySwigExplicitCallback(swigCPtr, this, call_id, nd_msg);
  }
  ...
  public void newCallCreated(String call_id, String arg1, String arg2) {
    if (getClass() == Callback.class) RingserviceJNI.Callback_newCallCreated(swigCPtr, this, call_id, arg1, arg2); else RingserviceJNI.Callback_newCallCreatedSwigExplicitCallback(swigCPtr, this, call_id, arg1, arg2);
  }
  ...
  public void conferenceRemove(String conf_id) {
    if (getClass() == Callback.class) RingserviceJNI.Callback_conferenceRemove(swigCPtr, this, conf_id); else RingserviceJNI.Callback_conferenceRemoveSwigExplicitCallback(swigCPtr, this, conf_id);
  }
  ...
  public Callback() {
    ...
    RingserviceJNI.Callback_director_connect(this, swigCPtr, swigCMemOwn, true);
  }
