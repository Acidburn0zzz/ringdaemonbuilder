...
public class Ringservice {
  ...
  public static void init(ConfigurationCallback confM, Callback callM, PresenceCallback presM, VideoCallback videoM) {
    RingserviceJNI.init(ConfigurationCallback.getCPtr(confM), confM, Callback.getCPtr(callM), callM, PresenceCallback.getCPtr(presM), presM, VideoCallback.getCPtr(videoM), videoM);
  }
